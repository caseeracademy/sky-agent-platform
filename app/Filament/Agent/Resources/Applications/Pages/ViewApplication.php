                    ...
                    ->tabs([
                        ...
                        Tab::make('Document Review')
                            ->schema([
                                ...
                                Section::make('Upload More Documents')
                                    ->schema([
                                        Placeholder::make('upload_info')
                                            ->label('Upload Additional Documents')
                                            ->content(function ($record) {
                                                if ($record->canBeEdited()) {
                                                    return '<div class="text-blue-600 font-medium">You can upload additional documents by editing this application.</div>';
                                                } else {
                                                    return '<div class="text-gray-500">Document uploads are no longer allowed for this application status.</div>';
                                                }
                                            })
                                            ->html(),
                                    ])
