...
<head>
    ...
    <title>All Universities Report</title>
    <style>
        body {
        ...
        .universities-table tr:nth-child(even) {
            background: white;
        }
                ...
                <tbody>
                    @foreach($universities as $university)
                        <tr>
                            ...
                            <td>{{ $university->country ?? 'Not specified' }}</td>
                            <td>{{ ucfirst($university->university_type ?? 'Public') }}</td>
